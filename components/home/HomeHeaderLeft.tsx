...
const HomeHeaderLeft = () => {
  return (
    <div className="w-full flex flex-col justify-center px-10">
      ...
      <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mt-2 text-appLightTextColor dark:text-appDarkTextColor">I&#39;m Aman Dewett</h2>
      <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl mt-3 text-appPrimaryColor font-bold overflow-hidden">
        <span>&#60;&#47;</span>
