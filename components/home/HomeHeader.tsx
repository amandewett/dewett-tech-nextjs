  ...
  return (
    ...
    >
      ...
      <div className="flex w-[40%] flex-col pl-20 tablet:w-[100%] phone:w-[100%] tablet:pr-20 phone:pr-20">
        ...
        <div className="pt-10 text-base text-justify xxlMonitor:text-xl">
          <p>
          ...
          items={arrCarouselImages.map((image: any) => {
            return (
              <ImageContainer
                ...
                width={450}
                height={450}
                className="ml-auto mr-auto xxlMonitor:w-[550px] xxlMonitor:h-[550px] laptop:w-[400px] laptop:h-[400px] tablet:w-[350px] tablet:h-[350px] phone:w-[300px] phone:h-[300px]"
              />
            );
          })}
        />
