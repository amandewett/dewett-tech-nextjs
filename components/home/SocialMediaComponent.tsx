  ...
  return (
    <motion.div ref={ref}>
      ...
      >
        ...
        <motion.a href="mailto:amandewett@gmail.com?subject=Requirement" target="_blank" variants={item} className="bg-[#A2D2FFCC] hover:bg-[#A2D2FF] transition-colors duration-300 rounded-[50%] p-2">
