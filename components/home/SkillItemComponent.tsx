...
const SkillItemComponent = ({ bgColor = "EC644E", text = "HTML", SkillIcon = FaHtml5, isLight = false, isSmall = false }: SkillItemComponentProps) => {
  ...
  return (
    <li style={{ backgroundColor: `#${bgColor}` }} className={`rounded-lg p-2 space-x-1 md:space-x-2 flex items-center justify-center mx-1 md:mx-2 group ${textClasses} cursor-pointer`}>
